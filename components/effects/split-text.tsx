...
export interface SplitTextProps {
  ...
  repeatable?: boolean; // Enable bidirectional animations
}
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  repeatable = false, // Default: one-time animation
}) => {
  const ref = useRef<HTMLParagraphElement>(null);
  const animationCompletedRef = useRef(false);
  const onCompleteRef = useRef(onLetterAnimationComplete);
  // Initialize fontsLoaded based on current state
          ...
          return gsap.fromTo(
            ...
            { ...from },
            {
              ...
              scrollTrigger: {
                trigger: el,
                start,
                once: !repeatable, // If repeatable, don't use once
                toggleActions: repeatable
